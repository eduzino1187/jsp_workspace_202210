...
<%
/*jsp 는 java 기술로 작성된 페이지이자, 오직 서버에
서만 실행되는 스크립트이다. 
클라이언의 html문서로 부터 전송되어온, 파라미터들을
넘겨받아 오라클에 넣어보자, 특히 오라클에 넣을때 
...
String id=request.getParameter("id");//id 를 넘겨받자
String pass=request.getParameter("pass");
String name=request.getParameter("name");

out.print("넘어온 id는 " + id);
out.print("넘어온 pass는 " + pass);
out.print("넘어온 name는 " + name);

//넘겨받은 파라미터(전송 되어온 변수)들을 오라클에
//넣기 
