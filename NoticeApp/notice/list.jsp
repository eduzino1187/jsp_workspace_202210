<!-- 아래와 같이 DOCTYPE 붙으면 html5 를 의미 하고, html5 차세대 html로써
...
<%!
	//선언부는 인스턴스 멤버 영역이므로, 여기에 선언한
	//변수는, 이 jsp의 인스턴스가 생성될때 초기화됨
...
<%
	...
	//전송되어 온 currentPage 를 jsp 의 currentPage 변수에 대입
	//널이 아닐때만, 아래의 페이지번호를 누르고 들어올때만..
