...
<%
	...
	//3) 파라미터명은 notice_idx 로 하기!!
	
	int notice_idx=Integer.parseInt(request.getParameter("notice_idx")); //완성하기!!
...
<body>
    ...
    <div class="container">
        <form method="post" action="/notice/regist.jsp">
            ...
            <!-- submit 은 현재 form 태그의 내용을 무조건 전송하므로
            무조건 전송을 방지하기 위해 일반  button -->
