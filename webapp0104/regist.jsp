...
<%
    ...
    //Connection 객체는 디폴트가 autoCommit이 true인 상태이기
    //때문에 무조건 트랜잭션  commit 하고 잇슴..따라서 , false로 바꾸자
    con.setAutoCommit(false);//자동 커밋 막기!! 
    //왜 막아야 하나? 개발자가 원할때 commit할려고..
